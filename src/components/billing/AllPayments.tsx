...
import { Monero, Money, Speedometer } from "iconsax-react-native";
import { getMonthAndYear, groupByMonthAndYear, months } from "@/utils";
interface props {
...
const AllPayments = ({ isRefetching, refetch, data, navigation }: props) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      style={[{ color: colors.black[400] }, font_styles["p4"]]}
                    >
                      GHS {parseInt(e?.billId?.totalAmountDue).toFixed(2)}
                    </Text>
                  </View>
                </Pressable>
              );
